...
# shuffle data
    ...
    train = train.loc[train['species'] != 'Adelie']
    test = test.loc[test['species'] != 'Adelie']
    ...
    ax[1].scatter(test.loc[test['species'] == 'Chinstrap'].to_numpy()[:, 0], test.loc[test['species'] == 'Chinstrap'].to_numpy()[:, 1], color='violet', label='Chinstrap ')
    ax[0].scatter(train.loc[train['species'] == 'Chinstrap'].to_numpy()[:, 0], train.loc[train['species'] == 'Chinstrap'].to_numpy()[:, 1], color='yellow', label='Chinstrap')
